...
@php
     ...
     * SEO
     */
    $canonicalUrl = url('/posts/trending');
    $titleText = 'Trending Articles — ' . $siteName;
    $metaDesc = 'Browse the most viewed posts in the last two weeks on ' . $siteName . '.';

    /**
     * Ads (reuse same system as search page)
     */
    $adsMap = null;
...
<div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8 py-3 sm:py-6 space-y-6">
    ...
    <x-ui.forum-hero
        ...
        description="Most viewed recent viral Articles"
        :postsTotal="$posts->total()"
        :basePath="url('/posts/trending')"
        :showSort="false"
    />
